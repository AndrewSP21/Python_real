...
class Cell:
    def __new__(cls, data=None):
        if str(data).isdigit():
            ...
            print('Клетка не создана, на вход должно подаваться количество ячеек')
            return None
    ...
    def __sub__(self, other):
        if other.size >= self.size:
            print('Операция не может быть выполнена, т.к. результат равен или меньше 0')
            return None
        else:
            return Cell(self.size - other.size)
    ...
    def __truediv__(self, other):
        if self.size // other.size == 0:
            print('Операция не может быть выполнена, т.к. результат равен 0')
            return None
        else:
            return Cell(self.size // other.size)
